...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |Morandin-Palumbo (Parte 2)|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
; Lautaro Morandin (C3), Matias Palumbo (C3)

; EJERCICIO 11 (PRACTICA 5 SEGUNDA PARTE)
...
; sumar los elementos de las listas que son elementos de l.
